...
type drpcEncoding_File_v1_remote_proto struct{}

func (drpcEncoding_File_v1_remote_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return drpc1.Marshal(msg)
}

func (drpcEncoding_File_v1_remote_proto) Unmarshal(buf []byte, msg drpc.Message) error {
	return drpc1.Unmarshal(buf, msg)
}

func (drpcEncoding_File_v1_remote_proto) JSONMarshal(msg drpc.Message) ([]byte, error) {
	return drpc1.JSONMarshal(msg)
}

func (drpcEncoding_File_v1_remote_proto) JSONUnmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcRemoteClient) Receive(ctx context.Context) (DRPCRemote_ReceiveClient, error) {
	stream, err := c.cc.NewStream(ctx, "/gokafkalite.v1.Remote/Receive", drpcEncoding_File_v1_remote_proto{})
	if err != nil {
		return nil, err
	}
...
func (x *drpcRemote_ReceiveClient) Send(m *Envelope) error {
	return x.MsgSend(m, drpcEncoding_File_v1_remote_proto{})
}

func (x *drpcRemote_ReceiveClient) Recv() (*Envelope, error) {
	m := new(Envelope)
	if err := x.MsgRecv(m, drpcEncoding_File_v1_remote_proto{}); err != nil {
		return nil, err
	}
	return m, nil
}
...
func (x *drpcRemote_ReceiveClient) RecvMsg(m *Envelope) error {
	return x.MsgRecv(m, drpcEncoding_File_v1_remote_proto{})
}
...
func (DRPCRemoteDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/gokafkalite.v1.Remote/Receive", drpcEncoding_File_v1_remote_proto{},
